window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function WorkbenchPanel({ wt: t, pickWorkspace, registerWorkspace, browseDirectory, makeDirectory, openFile, selectSession, showConversation, openWorkspace, startSession, removeWorkspace, listDirectory, useWorkspaces, useCapability, useScheme }) {
