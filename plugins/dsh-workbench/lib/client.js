window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = ":root{--wb-bg:var(--dsw-alias-bg-base,#0a0d14);--wb-panel:var(--dsw-alias-bg-layer-1,#141822);--wb-panel-solid:var(--dsw-alias-bg-layer-1,#141822);--wb-raised:var(--dsw-alias-bg-layer-2,#ffffff0a);--wb-overlay:var(--dsw-alias-bg-overlay,#171b24);--wb-line:var(--dsw-alias-border-l1,#ffffff1a);--wb-line-strong:var(--dsw-alias-border-l2,#ffffff2e);--wb-text:var(--dsw-alias-label-primary,#e8ecf5);--wb-text-dim:var(--dsw-alias-label-secondary,#e8ecf59e);--wb-text-faint:color-mix(in srgb, var(--wb-text-dim) 62%, transparent);--wb-accent:var(--dsw-alias-brand-primary,#679efe);--wb-danger:var(--dsw-alias-state-error-primary,#e45c5c);--wb-warn:var(--dsw-alias-state-warn-primary,#e09e36);--wb-ok:var(--dsw-alias-state-success-primary,#4ed17e);--wb-glass-tint:var(--wb-text);--wb-glass-edge:color-mix(in srgb, var(--wb-text) 16%, transparent);--wb-glass-sheen:color-mix(in srgb, var(--wb-text) 10%, transparent);--wb-scrim:#00000024;--wb-scrim-strong:#00000061;--wb-shadow:#0000004d;--wb-grid-minor:#ffffff0e;--wb-grid-major:#ffffff1c;--wb-grid-cell:16px;--wb-grid-block:80px}@property --wb-ring-angle{syntax:\"<angle>\";inherits:false;initial-value:0deg}.y5tTyq_workbench{box-sizing:border-box;background:radial-gradient(120% 60% at 50% -10%, color-mix(in srgb, var(--wb-accent) 8%, transparent), transparent 70%), var(--wb-bg);flex-direction:column;width:100%;height:100%;min-height:0;display:flex;position:relative;overflow:hidden}:root[data-wb-scheme=light]{--wb-bg:var(--dsw-alias-bg-base,#f7f8fa);--wb-panel:var(--dsw-alias-bg-layer-1,#fff);--wb-panel-solid:var(--dsw-alias-bg-layer-1,#fff);--wb-overlay:var(--dsw-alias-bg-overlay,#fff);--wb-scrim:color-mix(in srgb, var(--wb-text) 6%, transparent);--wb-scrim-strong:color-mix(in srgb, var(--wb-text) 14%, transparent);--wb-shadow:color-mix(in srgb, var(--wb-text) 12%, transparent);--wb-grid-minor:#b0801824;--wb-grid-major:#b080184d}.y5tTyq_workbench:before{content:\"\";pointer-events:none;background-image:linear-gradient(var(--wb-grid-minor) 1px, transparent 1px), linear-gradient(90deg, var(--wb-grid-minor) 1px, transparent 1px), linear-gradient(var(--wb-grid-major) 1px, transparent 1px), linear-gradient(90deg, var(--wb-grid-major) 1px, transparent 1px);background-size:var(--wb-grid-cell) var(--wb-grid-cell), var(--wb-grid-cell) var(--wb-grid-cell), var(--wb-grid-block) var(--wb-grid-block), var(--wb-grid-block) var(--wb-grid-block);position:absolute;inset:0;-webkit-mask-image:radial-gradient(130% 100% at 50% 0,#000 55%,#0000 100%);mask-image:radial-gradient(130% 100% at 50% 0,#000 55%,#0000 100%)}.y5tTyq_notice{border-bottom:1px solid var(--wb-line);background:color-mix(in srgb, var(--wb-warn) 14%, transparent);color:var(--wb-warn);margin:0;padding:10px 20px;font-size:12px;position:relative}.y5tTyq_noticeError{border-bottom:1px solid color-mix(in srgb, var(--wb-danger) 32%, transparent);background:color-mix(in srgb, var(--wb-danger) 14%, transparent);color:var(--wb-danger);align-items:center;gap:10px;margin:0;padding:10px 14px 10px 20px;font-size:12px;display:flex;position:relative}.y5tTyq_noticeErrorText{flex:1;min-width:0}.y5tTyq_noticeClose{border:1px solid color-mix(in srgb, var(--wb-danger) 38%, transparent);width:22px;height:22px;color:inherit;font:inherit;cursor:pointer;background:0 0;border-radius:6px;flex:none;padding:0;font-size:11px;line-height:1}.y5tTyq_noticeClose:hover{background:color-mix(in srgb, var(--wb-glass-tint) 13%, transparent)}.y5tTyq_panelHead{border-bottom:1px solid var(--wb-line);justify-content:space-between;align-items:center;gap:16px;padding:18px 20px;display:flex;position:relative}.y5tTyq_headIdentity{align-items:center;gap:12px;min-width:0;display:flex}.y5tTyq_headGlyph{border:1px solid var(--wb-line-strong);background:linear-gradient(150deg, color-mix(in srgb, var(--wb-accent) 30%, transparent), color-mix(in srgb, var(--wb-accent) 5%, transparent));width:38px;height:38px;color:color-mix(in srgb, var(--wb-accent) 62%, var(--wb-text));box-shadow:0 0 24px color-mix(in srgb, var(--wb-accent) 26%, transparent);border-radius:12px;flex:none;justify-content:center;align-items:center;display:inline-flex}.y5tTyq_headText{min-width:0}.y5tTyq_title{letter-spacing:.04em;color:var(--wb-text);margin:0;font-size:17px;font-weight:600}.y5tTyq_subtitle{color:var(--wb-text-faint);margin:3px 0 0;font-size:12px}.y5tTyq_headActions{flex:none;align-items:center;gap:8px;display:flex}.y5tTyq_live{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--wb-ok) 34%, transparent);background:color-mix(in srgb, var(--wb-ok) 12%, transparent);height:28px;color:var(--wb-ok);letter-spacing:.06em;text-transform:uppercase;border-radius:999px;align-items:center;gap:6px;padding:0 10px;font-size:11px;display:inline-flex}.y5tTyq_liveDot{background:var(--wb-ok);width:6px;height:6px;box-shadow:0 0 10px var(--wb-ok);border-radius:50%;animation:2s ease-in-out infinite y5tTyq_wbPulse}.y5tTyq_action{box-sizing:border-box;border:1px solid var(--wb-line-strong);background:color-mix(in srgb, var(--wb-glass-tint) 5%, transparent);height:30px;color:var(--wb-text);font:inherit;cursor:pointer;transition:background .16s var(--ds-ease-in-out), border-color .16s var(--ds-ease-in-out);border-radius:9px;align-items:center;gap:6px;padding:0 12px;font-size:12px;display:inline-flex}.y5tTyq_action:hover{background:color-mix(in srgb, var(--wb-glass-tint) 10%, transparent);border-color:color-mix(in srgb, var(--wb-glass-tint) 22%, transparent)}.y5tTyq_action:focus-visible{outline:2px solid var(--wb-accent);outline-offset:2px}.y5tTyq_iconOnly{box-sizing:border-box;width:30px;height:30px;color:var(--wb-text-dim);cursor:pointer;transition:background .16s var(--ds-ease-in-out), color .16s var(--ds-ease-in-out);background:0 0;border:1px solid #0000;border-radius:9px;justify-content:center;align-items:center;padding:0;display:inline-flex}.y5tTyq_iconOnly:hover{background:color-mix(in srgb, var(--wb-glass-tint) 9%, transparent);color:var(--wb-text)}.y5tTyq_readings{border-bottom:1px solid var(--wb-line);grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;padding:16px 20px;display:grid;position:relative}.y5tTyq_reading{border:1px solid var(--wb-line);background:linear-gradient(180deg, color-mix(in srgb, var(--wb-glass-tint) 6%, transparent), color-mix(in srgb, var(--wb-glass-tint) 2%, transparent));border-radius:14px;flex-direction:column;gap:6px;padding:12px 14px;display:flex}.y5tTyq_readingLabel{letter-spacing:.08em;text-transform:uppercase;color:var(--wb-text-faint);font-size:11px}.y5tTyq_readingValue{color:var(--wb-text);font-variant-numeric:tabular-nums;font-size:24px;font-weight:600;line-height:1.1}.y5tTyq_readingHint{color:var(--wb-text-dim);font-variant-numeric:tabular-nums;font-size:11px}.y5tTyq_projects{scrollbar-width:thin;scrollbar-color:color-mix(in srgb, var(--wb-glass-tint) 17%, transparent) transparent;flex:1;grid-template-columns:repeat(auto-fill,minmax(320px,1fr));gap:14px;min-height:0;padding:18px 20px 22px;display:grid;position:relative;overflow-y:auto}.y5tTyq_projects::-webkit-scrollbar{width:10px}.y5tTyq_projects::-webkit-scrollbar-thumb{background-clip:content-box;background-color:color-mix(in srgb, var(--wb-glass-tint) 17%, transparent);border:3px solid #0000;border-radius:8px}.y5tTyq_card{--card-accent:var(--wb-accent);border:1px solid var(--wb-glass-edge);border-top-color:color-mix(in srgb, var(--wb-glass-tint) 26%, transparent);background:linear-gradient(158deg, color-mix(in srgb, var(--wb-glass-tint) 9%, transparent) 0%, color-mix(in srgb, var(--wb-glass-tint) 3%, transparent) 40%, color-mix(in srgb, var(--wb-glass-tint) 1%, transparent) 100%), color-mix(in srgb, var(--wb-panel) 38%, transparent);-webkit-backdrop-filter:blur(22px)saturate(180%);box-shadow:inset 0 1px 0 color-mix(in srgb, var(--wb-glass-tint) 20%, transparent), inset 0 -1px 0 color-mix(in srgb, var(--wb-glass-tint) 5%, transparent), 0 10px 28px var(--wb-shadow);transition:transform .22s var(--ds-ease-in-out), border-color .22s var(--ds-ease-in-out), box-shadow .22s var(--ds-ease-in-out);border-radius:18px;flex-direction:column;gap:10px;padding:14px 14px 12px;display:flex;position:relative}.y5tTyq_card:after{content:\"\";z-index:-1;pointer-events:none;--wb-ring-angle:0deg;background:0 0;border-radius:20px;position:absolute;inset:-2px}.y5tTyq_card:before{content:\"\";z-index:1;background:linear-gradient(180deg, var(--card-accent), transparent 85%);width:3px;box-shadow:0 0 14px color-mix(in srgb, var(--card-accent) 70%, transparent);opacity:.9;position:absolute;inset:0 auto 0 0}.y5tTyq_card:hover{border-color:color-mix(in srgb, var(--wb-glass-tint) 24%, transparent);box-shadow:inset 0 1px 0 color-mix(in srgb, var(--wb-glass-tint) 30%, transparent), 0 18px 44px var(--wb-scrim-strong);transform:translateY(-2px)}.y5tTyq_cardFiles{min-height:260px}.y5tTyq_cardHead{align-items:center;gap:8px;min-width:0;display:flex}.y5tTyq_cardOpen{min-width:0;color:inherit;font:inherit;text-align:left;cursor:pointer;transition:background .16s var(--ds-ease-in-out);background:0 0;border:none;border-radius:8px;flex:1;align-items:center;gap:8px;margin:-2px -4px -2px -2px;padding:2px 4px 2px 2px;display:flex}.y5tTyq_cardOpen:hover:not(:disabled){background:color-mix(in srgb, var(--wb-glass-tint) 7%, transparent)}.y5tTyq_cardOpen:disabled{cursor:default}.y5tTyq_cardOpen:focus-visible{outline:2px solid var(--wb-accent);outline-offset:1px}.y5tTyq_cardGlyph{border:1px solid var(--wb-line);background:color-mix(in srgb, var(--card-accent) 16%, transparent);width:26px;height:26px;color:var(--card-accent);border-radius:8px;flex:none;justify-content:center;align-items:center;display:inline-flex}.y5tTyq_cardTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--wb-text);flex:1;font-size:14px;font-weight:600;overflow:hidden}.y5tTyq_cardPath{text-overflow:ellipsis;white-space:nowrap;font-family:var(--ds-font-family-code);letter-spacing:-.01em;color:color-mix(in srgb, var(--wb-accent) 55%, var(--wb-text));margin:0;font-size:11.5px;overflow:hidden}.y5tTyq_explorer{border:1px solid var(--wb-line);background:var(--wb-scrim);border-radius:12px;flex-direction:column;flex:1;min-height:0;display:flex;overflow:hidden}.y5tTyq_explorerHead{border-bottom:1px solid var(--wb-line);background:color-mix(in srgb, var(--wb-glass-tint) 4%, transparent);flex:none;align-items:center;gap:4px;height:26px;padding:0 6px 0 4px;display:flex}.y5tTyq_explorerCaret{color:var(--wb-text-faint);flex:none}.y5tTyq_explorerTitle{text-overflow:ellipsis;white-space:nowrap;letter-spacing:.08em;color:var(--wb-text-dim);flex:none;font-size:11px;font-weight:700;overflow:hidden}.y5tTyq_explorerParent{text-overflow:ellipsis;white-space:nowrap;text-align:right;min-width:0;color:var(--wb-text-faint);flex:1;font-size:10.5px;overflow:hidden}.y5tTyq_explorerTools{flex:none;align-items:center;gap:2px;display:inline-flex}.y5tTyq_explorerTool{width:20px;height:20px;color:var(--wb-text-dim);cursor:pointer;transition:background .14s var(--ds-ease-in-out), color .14s var(--ds-ease-in-out);background:0 0;border:none;border-radius:5px;justify-content:center;align-items:center;padding:0;display:inline-flex}.y5tTyq_explorerTool:hover:not(:disabled){background:color-mix(in srgb, var(--wb-glass-tint) 11%, transparent);color:var(--wb-text)}.y5tTyq_explorerTool:disabled{color:var(--wb-text-faint);cursor:default;opacity:.5}.y5tTyq_explorerTool:focus-visible,.y5tTyq_explorerRow:focus-visible,.y5tTyq_explorerRetry:focus-visible{outline:1px solid var(--wb-accent);outline-offset:-1px}.y5tTyq_explorerRows{scrollbar-width:thin;scrollbar-color:color-mix(in srgb, var(--wb-glass-tint) 17%, transparent) transparent;flex:1;min-height:0;margin:0;padding:4px 0;list-style:none;overflow:auto}.y5tTyq_explorerRows::-webkit-scrollbar{width:10px}.y5tTyq_explorerRows::-webkit-scrollbar-thumb{background-clip:content-box;background-color:color-mix(in srgb, var(--wb-glass-tint) 17%, transparent);border:3px solid #0000;border-radius:8px}.y5tTyq_explorerItem{min-width:0}.y5tTyq_explorerRow{box-sizing:border-box;width:100%;height:22px;color:var(--wb-text);font:inherit;text-align:left;white-space:nowrap;cursor:pointer;background:0 0;border:none;align-items:center;gap:4px;padding:0 6px 0 4px;font-size:12.5px;line-height:22px;display:flex}.y5tTyq_explorerRow:hover{background:color-mix(in srgb, var(--wb-glass-tint) 6%, transparent)}.y5tTyq_explorerRowSelected{background:color-mix(in srgb, var(--wb-accent) 20%, transparent);box-shadow:inset 2px 0 0 var(--wb-accent)}.y5tTyq_explorerRowSelected:hover{background:color-mix(in srgb, var(--wb-accent) 24%, transparent)}.y5tTyq_explorerGuide{background-image:linear-gradient(90deg, color-mix(in srgb, var(--wb-text) 12%, transparent) 0 1px, transparent 1px);background-repeat:no-repeat;flex:none;align-self:stretch;width:14px}.y5tTyq_explorerGlyph{width:14px;color:var(--wb-text-faint);flex:none;justify-content:center;align-items:center;display:inline-flex}.y5tTyq_explorerRow:hover .y5tTyq_explorerGlyph{color:var(--wb-text-dim)}.y5tTyq_explorerIcon{width:18px;color:color-mix(in srgb, var(--wb-accent) 42%, var(--wb-text-dim));flex:none;justify-content:center;align-items:center;display:inline-flex}.y5tTyq_explorerRow[data-explorer-kind=file] .y5tTyq_explorerIcon{color:inherit}.y5tTyq_explorerName{text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}.y5tTyq_explorerSize{color:var(--wb-text-faint);font-variant-numeric:tabular-nums;flex:none;padding-left:8px;font-size:10.5px}.y5tTyq_explorerNoteRow{box-sizing:border-box;height:22px;color:var(--wb-text-faint);align-items:center;gap:4px;padding:0 6px 0 4px;font-size:11.5px;display:flex}.y5tTyq_explorerNoteText{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.y5tTyq_explorerErrorText{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--wb-danger);flex:1;overflow:hidden}.y5tTyq_explorerRetry{border:1px solid var(--wb-line-strong);height:18px;color:var(--wb-text);font:inherit;cursor:pointer;background:0 0;border-radius:999px;flex:none;padding:0 8px;font-size:10.5px}.y5tTyq_explorerRetry:hover{background:color-mix(in srgb, var(--wb-glass-tint) 11%, transparent)}.y5tTyq_explorerSpin{animation:1s linear infinite y5tTyq_wbSpin}.y5tTyq_explorerNote{color:var(--wb-text-dim);margin:0;padding:14px 12px;font-size:12px}.y5tTyq_explorerFoot{border-top:1px solid var(--wb-line);color:var(--wb-text-faint);text-overflow:ellipsis;white-space:nowrap;flex:none;margin:0;padding:5px 8px;font-size:10.5px;overflow:hidden}.y5tTyq_picker{width:min(560px,92vw);color:var(--wb-text)}.y5tTyq_pickerContent{max-height:min(560px,72vh)}.y5tTyq_pickerCrumbs{flex-wrap:wrap;align-items:center;gap:2px;padding:0 0 8px;font-size:12px;display:flex}.y5tTyq_pickerCrumbCell{align-items:center;gap:2px;min-width:0;display:inline-flex}.y5tTyq_pickerCrumbSep{color:var(--wb-text-faint)}.y5tTyq_pickerCrumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--wb-text-dim);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:6px;padding:2px 6px;font-size:12px;overflow:hidden}.y5tTyq_pickerCrumb:hover{background:color-mix(in srgb, var(--wb-glass-tint) 9%, transparent);color:var(--wb-text)}.y5tTyq_pickerCrumbCurrent{color:var(--wb-text);font-weight:600}.y5tTyq_pickerAddress{align-items:center;gap:6px;padding:0 0 8px;display:flex}.y5tTyq_pickerAddressInput{min-width:0;font-family:var(--ds-font-family-code);flex:1;font-size:12px}.y5tTyq_pickerBar{border-bottom:1px solid var(--wb-line);align-items:center;gap:8px;padding:0 0 8px;display:flex}.y5tTyq_pickerPath{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-family:var(--ds-font-family-code);color:color-mix(in srgb, var(--wb-accent) 55%, var(--wb-text));flex:1;font-size:11.5px;overflow:hidden}.y5tTyq_pickerToggle{color:var(--wb-text-dim);cursor:pointer;flex:none;align-items:center;gap:5px;font-size:11px;display:inline-flex}.y5tTyq_pickerTool{width:22px;height:22px;color:var(--wb-text-dim);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.y5tTyq_pickerTool:hover:not(:disabled){background:color-mix(in srgb, var(--wb-glass-tint) 11%, transparent);color:var(--wb-text)}.y5tTyq_pickerTool:disabled{opacity:.45;cursor:default}.y5tTyq_pickerCreate{align-items:center;gap:8px;padding:8px 0;display:flex}.y5tTyq_pickerNotice{border:1px solid color-mix(in srgb, var(--wb-danger) 32%, transparent);background:color-mix(in srgb, var(--wb-danger) 14%, transparent);color:var(--wb-danger);border-radius:8px;margin:0 0 8px;padding:6px 8px;font-size:11.5px}.y5tTyq_pickerRows{border:1px solid var(--wb-line);background:var(--wb-scrim);scrollbar-width:thin;scrollbar-color:color-mix(in srgb, var(--wb-glass-tint) 17%, transparent) transparent;border-radius:10px;min-height:180px;max-height:300px;padding:4px 0;overflow:auto}.y5tTyq_pickerRows::-webkit-scrollbar{width:10px}.y5tTyq_pickerRows::-webkit-scrollbar-thumb{background-clip:content-box;background-color:color-mix(in srgb, var(--wb-glass-tint) 17%, transparent);border:3px solid #0000;border-radius:8px}.y5tTyq_pickerRow{box-sizing:border-box;width:100%;height:26px;color:var(--wb-text);font:inherit;text-align:left;white-space:nowrap;cursor:pointer;background:0 0;border:none;align-items:center;gap:6px;padding:0 10px;font-size:12.5px;display:flex}.y5tTyq_pickerRow:hover{background:color-mix(in srgb, var(--wb-glass-tint) 7%, transparent)}.y5tTyq_pickerNote{color:var(--wb-text-faint);align-items:center;gap:6px;margin:0;padding:8px 10px;font-size:11.5px;display:flex}.y5tTyq_editor{flex-direction:column;height:100%;min-height:0;font-size:12.5px;display:flex}.y5tTyq_editorHead{border-bottom:1px solid var(--dsw-alias-border-l2,var(--wb-line));flex:none;align-items:center;gap:6px;padding:6px 8px;display:flex}.y5tTyq_editorName{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;font-weight:600;overflow:hidden}.y5tTyq_editorDirty{color:var(--wb-warn);flex:none;font-size:10px}.y5tTyq_editorTools{flex:none;align-items:center;gap:4px;display:inline-flex}.y5tTyq_editorMeta{opacity:.6;font-variant-numeric:tabular-nums;font-size:10.5px}.y5tTyq_editorNotice{background:color-mix(in srgb, var(--wb-warn) 16%, transparent);color:var(--wb-warn);flex:none;margin:0;padding:6px 10px;font-size:11.5px}.y5tTyq_editorNote{opacity:.75;flex-direction:column;align-items:flex-start;gap:8px;margin:0;padding:12px 10px;font-size:12px;display:flex}.y5tTyq_editorFailed{color:var(--wb-danger);margin:0}.y5tTyq_editorBody{min-height:0;font-family:var(--ds-font-family-code);flex:1;display:flex;overflow:auto}.y5tTyq_editorGutter{text-align:right;opacity:.4;user-select:none;font-variant-numeric:tabular-nums;flex-direction:column;flex:none;padding:8px 8px 8px 10px;font-size:11.5px;line-height:1.5;display:flex}.y5tTyq_editorLineNo{display:block}.y5tTyq_editorText,.y5tTyq_editorInput{min-width:0;color:inherit;font:inherit;tab-size:2;white-space:pre;background:0 0;border:none;outline:none;flex:1;margin:0;padding:8px 12px 8px 0;font-size:12.5px;line-height:1.5}.y5tTyq_editorText{overflow:visible}.y5tTyq_editorInput{resize:none;white-space:pre;overflow:hidden}.y5tTyq_editorFoot{border-top:1px solid var(--dsw-alias-border-l2,var(--wb-line));flex:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.y5tTyq_editorHint{text-overflow:ellipsis;white-space:nowrap;opacity:.6;flex:1;min-width:0;font-size:10.5px;overflow:hidden}.y5tTyq_editorChip{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.y5tTyq_cardFoot{justify-content:space-between;align-items:center;gap:10px;padding-top:2px;display:flex}.y5tTyq_cardUpdated{color:var(--wb-text-faint);font-variant-numeric:tabular-nums;font-size:11px}.y5tTyq_card[data-card-status=idle]{border-color:var(--wb-glass-edge)}.y5tTyq_card[data-card-status=running]{border-color:#0000}.y5tTyq_card[data-card-status=running]:after{background:conic-gradient(from var(--wb-ring-angle), var(--wb-accent) 0deg, var(--wb-accent) 22deg, transparent 38deg, transparent 322deg, var(--wb-accent) 338deg, var(--wb-accent) 360deg);box-shadow:0 0 18px color-mix(in srgb, var(--wb-accent) 50%, transparent), inset 0 0 18px color-mix(in srgb, var(--wb-accent) 35%, transparent);animation:1.6s linear infinite y5tTyq_wbRingSpin}.y5tTyq_card[data-card-status=completed]{border-color:var(--wb-ok);box-shadow:inset 0 1px 0 color-mix(in srgb, var(--wb-glass-tint) 20%, transparent), inset 0 -1px 0 color-mix(in srgb, var(--wb-glass-tint) 5%, transparent), 0 10px 28px var(--wb-shadow), 0 0 0 0 color-mix(in srgb, var(--wb-ok) 60%, transparent)}.y5tTyq_card[data-card-status=completed][data-card-acknowledged=false]{animation:1.4s ease-in-out infinite y5tTyq_wbCompletedPulse}.y5tTyq_card[data-card-status=completed][data-card-acknowledged=true]{border-color:var(--wb-ok);box-shadow:inset 0 1px 0 color-mix(in srgb, var(--wb-glass-tint) 20%, transparent), inset 0 -1px 0 color-mix(in srgb, var(--wb-glass-tint) 5%, transparent), 0 10px 28px var(--wb-shadow);animation:none}.y5tTyq_addCard{border:1px dashed var(--wb-line-strong);background:color-mix(in srgb, var(--wb-glass-tint) 3%, transparent);-webkit-backdrop-filter:blur(14px)saturate(150%);min-height:190px;color:var(--wb-text-dim);font:inherit;cursor:pointer;transition:border-color .18s var(--ds-ease-in-out), background .18s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out);border-radius:18px;flex-direction:column;justify-content:center;align-items:center;gap:6px;padding:18px;display:flex}.y5tTyq_addCard:hover:not(:disabled){border-color:color-mix(in srgb, var(--wb-accent) 60%, transparent);background:color-mix(in srgb, var(--wb-accent) 8%, transparent);transform:translateY(-2px)}.y5tTyq_addCard:disabled{cursor:progress;opacity:.6}.y5tTyq_addGlyph{border:1px solid var(--wb-line-strong);background:linear-gradient(150deg, color-mix(in srgb, var(--wb-accent) 24%, transparent), transparent);width:44px;height:44px;color:color-mix(in srgb, var(--wb-accent) 62%, var(--wb-text));border-radius:14px;justify-content:center;align-items:center;display:inline-flex}.y5tTyq_addTitle{color:var(--wb-text);font-size:13px}.y5tTyq_addHint{color:var(--wb-text-faint);font-size:11.5px}.y5tTyq_accent_azure{--card-accent:#679efe}.y5tTyq_accent_violet{--card-accent:#a78bfa}.y5tTyq_accent_amber{--card-accent:#f7ad31}.y5tTyq_accent_emerald{--card-accent:#4ed17e}.y5tTyq_accent_rose{--card-accent:var(--wb-danger)}.y5tTyq_accent_slate{--card-accent:#979da6}.y5tTyq_empty{border:1px dashed var(--wb-line-strong);background:color-mix(in srgb, var(--wb-glass-tint) 3%, transparent);-webkit-backdrop-filter:blur(14px)saturate(150%);text-align:center;border-radius:18px;flex-direction:column;grid-column:1/-1;justify-content:center;align-items:center;gap:8px;padding:56px 24px;display:flex}.y5tTyq_emptyGlyph{border:1px solid var(--wb-line-strong);background:linear-gradient(150deg, color-mix(in srgb, var(--wb-accent) 24%, transparent), transparent);width:46px;height:46px;color:color-mix(in srgb, var(--wb-accent) 62%, var(--wb-text));border-radius:14px;justify-content:center;align-items:center;display:inline-flex}.y5tTyq_emptyTitle{color:var(--wb-text);margin:6px 0 0;font-size:14px}.y5tTyq_emptyHint{color:var(--wb-text-faint);margin:0 0 10px;font-size:12px}.y5tTyq_panelFoot{border-top:1px solid var(--wb-line);background:var(--wb-scrim);justify-content:space-between;align-items:center;padding:10px 20px;display:flex;position:relative}.y5tTyq_footHint{color:var(--wb-text-faint);font-size:11px}@media (width<=760px){.y5tTyq_readings{grid-template-columns:repeat(2,minmax(0,1fr))}.y5tTyq_live{display:none}}@keyframes y5tTyq_wbPulse{0%,to{opacity:1}50%{opacity:.35}}@keyframes y5tTyq_wbSpin{to{transform:rotate(360deg)}}@keyframes y5tTyq_wbRingSpin{to{--wb-ring-angle:360deg}}@keyframes y5tTyq_wbCompletedPulse{0%,to{box-shadow:inset 0 1px 0 color-mix(in srgb, var(--wb-glass-tint) 20%, transparent), inset 0 -1px 0 color-mix(in srgb, var(--wb-glass-tint) 5%, transparent), 0 10px 28px var(--wb-shadow), 0 0 0 0 color-mix(in srgb, var(--wb-ok) 60%, transparent)}50%{box-shadow:inset 0 1px 0 color-mix(in srgb, var(--wb-glass-tint) 20%, transparent), inset 0 -1px 0 color-mix(in srgb, var(--wb-glass-tint) 5%, transparent), 0 10px 28px var(--wb-shadow), 0 0 0 6px color-mix(in srgb, var(--wb-ok) 0%, transparent)}}@media (prefers-reduced-motion:reduce){.y5tTyq_liveDot,.y5tTyq_explorerSpin,.y5tTyq_card[data-card-status=running]:after,.y5tTyq_card[data-card-status=completed][data-card-acknowledged=false]{animation:none}.y5tTyq_card,.y5tTyq_addCard{transition:none}}";
