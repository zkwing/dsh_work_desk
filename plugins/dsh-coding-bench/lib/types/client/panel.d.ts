...
export declare function MainSlotBody(props: CodingBenchPanelProps): ReactNode;
...
export declare function BenchPageBody(props: CodingBenchPageProps): ReactNode;
...
export declare function BenchPageChip(props: CodingBenchPageChipProps): ReactNode;
 ...
 *  visual pass lands. */
export declare function CodingBenchPanelIcon(): ReactNode;
